...
**Sanaa na Michezo** — Hiki ni kitabu cha mwanafunzi cha Sanaa na Michezo kwa Darasa la Tano kutoka Tanzania Bara, kilichoandaliwa na Taasisi ya Elimu Tanzania na kuandikwa kwa lugha ya Kiswahili. Kinafundisha sanaa za uigizaji, uimbaji na ala za muziki, uchoraji, ufinyanzi, pamoja na utengenezaji wa maumbo sahili, sambamba na mazoezi ya viungo, michezo ya asili, na michezo ya kisasa kama mpira wa miguu na netiboli. Maudhui yake yanaonesha mkabala wa kujifunza kwa vitendo kupitia picha, mazoezi, kazi za vikundi na mijadala, yakilenga kukuza ubunifu, stadi za maisha, afya, ushirikiano na ujasiriamali kwa wanafunzi wa shule ya msingi.
...
├── SANAA-NA-MICHEZO-5-a.db                    # SQLite database (pipeline state)
├── SANAA-NA-MICHEZO-5-a.pdf                   # Original source PDF
...
{
  "pg001_gp001_tx001": "",
  "pg001_im001": "Cheti rasmi cha idhinishi cha Serikali ya Tanzania kwa kitabu cha Sanaa na Michezo cha mwanafunzi wa Darasa la Tano, kikionyesha jina la kitabu, taasisi ya uchapishaji, tarehe ya kuidhinishwa na saini ya Kamishna wa Elimu.",
  "gl001": "ala za muziki",
  "gl001_def": "vifaa vinavyotumiwa kupiga au kutoa sauti za muziki."
}
```
...
```json
{
  "ala za muziki": {
    "word": "ala za muziki",
    "definition": "vifaa vinavyotumiwa kupiga au kutoa sauti za muziki.",
    "variations": ["ala ya muziki","ala za muziki"],
    "emoji": "🎹🥁🎺"
  }
}
```
...
| Original PDF | `SANAA-NA-MICHEZO-5-a.pdf` |
| Pipeline database | `SANAA-NA-MICHEZO-5-a.db` (SQLite) |
